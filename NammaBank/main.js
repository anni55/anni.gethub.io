...
// Regex and SignIn button click
    ...
    // SignIn button click
        ...
        function addAccounts()
        {
            ...
            accounts.push({owner: `${signinFullName.value}`, movements: [100,20], password: `${signinPassword.value}`, userName: `${signinUserName.value}`, dates:[`${day}-${month}-${year}, ${date.getHours()}:${date.getMinutes()}`,`${day}-${month}-${year}, ${date.getHours()}:${date.getMinutes()}`] });
        ...
        function fundAccount()
        {
            ...
            // alert(accounts[yourAccount].dates);
            if(yourAccount >= 0)
            {
